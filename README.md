...
This repository hosts some helm charts which we commonly use in our projects. [Kubernetes](https://kubernetes.io/)
...
```console
make lint -- --charts stable/<chart-name>
```

You can force to lint a list of charts (separated by comma) with `--charts` flag:

```console
make lint -- --charts stable/<chart-name-0>,stable/xray<chart-name-1>
```
...
```console
make mac -- --charts stable/<chart-name>
```

You can force to install a list of charts (separated by comma) with `--charts` flag:

```console
make mac -- --charts stable/<chart-name-0>,stable/<chart-name-1>
```
...
```console
make gke -- --charts stable/<chart-name>
```

You can force to install a list of charts (separated by comma) with `--charts` flag:

```console
make gke -- --charts stable/<chart-name-0>,stable/<chart-name-1>
```
